...
<div class="row">
      ...
      <div class="col-md-3 m-0 p-0 text-center border m-2" style="font-size: 1.1rem;">
        <h4 class="font-weight-bold" style="background-color: #f39e7a; height: 40px;"><p>Customer ID <?php echo $rows["id"] ?></p></h4>
        <div>
...
<div>
  ...
  <a href="https://www.linkedin.com/in/ruchir-bhagwat-633351194/"><i class="fa fa-linkedin-square" style="color:white"></i></a>&nbsp;
  <a href="https://www.google.com/"><i class="fa fa-google" style="color:white"></i></a>&nbsp;
  <a href="https://github.com/Ruchir20"><i class="fa fa-github" style="color:white"></i></a>&nbsp;
  </div> 
  <small>&copy; Copyright 2022, Ruchir Bhagwat</small>
  <br>
</footer>
